...
//    printf("max:%d",maximum);
    ...
    server_message1.pos.x = 0;
    server_message1.pos.y = 0;
...
//                write(fd[i][0], &server_message1, sizeof(server_message));
                char msj[50] = "Server-";

                write(fd[i][0], msj, 50);


//                ssize_t n = read(fd[i][0], &server_message1, 255);
//                printf("server%d -> %d", i, server_message1.pos.x);
                ssize_t n = read(fd[i][0], buff, 255);
                printf("server%d -> %s", i, buff);
